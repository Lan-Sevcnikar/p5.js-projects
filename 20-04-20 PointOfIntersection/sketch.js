...
let shapes = [];
let pivot = new Point(100,screenHeight-100);
...
function setup() {
	...
	let p4 = new Point(300,200);
	let o = new Shape([p1,p2,p3,p4,p1]);
	shapes.push(o);
	p1 = new Point(600,600);
	p2 = new Point(600,750);
	p3 = new Point(750,750);
	p4 = new Point(750,600);
	o = new Shape([p1,p2,p3,p4,p1]);
	shapes.push(o);
	p1 = new Point(700,100);
	p2 = new Point(700,200);
	p3 = new Point(900,200);
	p4 = new Point(900,100);
	o = new Shape([p1,p2,p3,p4,p1]);
	shapes.push(o);
	p1 = new Point(1000,500);
	p2 = new Point(1000,800);
	p3 = new Point(1050,800);
	p4 = new Point(1050,500);
	o = new Shape([p1,p2,p3,p4,p1]);
	shapes.push(o);
	//noStroke();
}
...
function draw()	{
	...
	console.log(ray.simulate(ray.x,ray.y,0));
}